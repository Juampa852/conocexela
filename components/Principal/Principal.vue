<template>
    ...
    <div class="Field">
      ...
      <b-carousel-slide class="Field_slide_small" img-src="/main_images/Slider/_DSC0840.JPG">
          <h1 class="small-h1">Nuestra gente y sus tradiciones...</h1>
        </b-carousel-slide>
